...
const ModalWrapper: React.FC<{
    ...
    desc: string;
    path: string;
    changeCurrentBigImage: (next: boolean) => void;
}> = ({ src, title, desc, path, changeCurrentBigImage }) => {
    ...
    return (
        ...
        >
            <div className="relative" style={{ width: "95vw", height: "95vh" }}>
                <div
                    className="bg-gray-100 inline p-2 absolute rounded-lg border-4 border-gray-400 hover:opacity-0 text-center"
                    style={{
                        left: "50%",
                ...
                <div
                    className="bg-gray-100 inline p-1 absolute rounded-lg border-4 border-gray-400 text-center"
                    style={{
                        left: "50%",
